              ...
              <section className="bg-zinc-900/40 border border-white/5 rounded-[1.2rem] p-5 flex flex-col gap-3 mt-auto">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    ...
                    <input type="number" step="0.5" className="w-12 bg-black border border-white/5 rounded-lg p-1 text-center text-amber-500 text-[10px] font-bold outline-none" defaultValue="60" onChange={e => setPassingGrade(parseFloat(e.target.value) || 0)} />
                  </div>
                </div>
